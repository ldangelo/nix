...
windowAction.new(super, hs.keycodes.map["^"], "swap", images.swap) --["y"]
windowAction.new(super, hs.keycodes.map["’"], "warp", images.warp) --["n"]
windowAction.new(super, hs.keycodes.map["c"], "stack", images.stack) --["h"]
...
hs.hotkey.bind(super, hs.keycodes.map["\""],
	function() yabai({ "-m", "space", "mouse", "--layout", "bsp" }, function() toast("🖖") end) end) --["1"]
hs.hotkey.bind(super, hs.keycodes.map["«"],
	function() yabai({ "-m", "space", "mouse", "--layout", "stack" }, function() toast("📚") end) end) --["2"]
hs.hotkey.bind(super, hs.keycodes.map["»"],
	function() yabai({ "-m", "space", "mouse", "--layout", "float" }, function() toast("☁️") end) end) --["3"]


--# rotate space
hs.hotkey.bind(super, hs.keycodes.map["h"],
	function() yabai({ "-m", "space", "--rotate", "270" }, function() toast("🔲🔁") end) end) --["."]


--# focus fullscreen
hs.hotkey.bind(super, hs.keycodes.map["q"], function() yabai({ "-m", "window", "--toggle", "zoom-fullscreen" }) end) --["m"]
...
hs.hotkey.bind(super, hs.keycodes.map["è"],
	function() yabai({ "-m", "window", "--focus", "stack.next" }, function() toast("📚↥") end) end) --["t"]
hs.hotkey.bind(super, hs.keycodes.map[","],
	function() yabai({ "-m", "window", "--focus", "stack.prev" }, function() toast("📚↧") end) end) --["g"]


--# change window focus to direction
hs.hotkey.bind(super, hs.keycodes.map["n"], function() yabai({ "-m", "window", "--focus", "east" }) end) --[";"]
hs.hotkey.bind(super, hs.keycodes.map["t"], function() yabai({ "-m", "window", "--focus", "west" }) end) --["j"]
hs.hotkey.bind(super, hs.keycodes.map["r"], function() yabai({ "-m", "window", "--focus", "north" }) end) --["l"]
hs.hotkey.bind(super, hs.keycodes.map["s"], function() yabai({ "-m", "window", "--focus", "south" }) end) --["k"]


--# bsp ratio
hs.hotkey.bind(super, hs.keycodes.map["+"], function() yabai({ "-m", "window", "--ratio", "abs:0.38" }) toast("🔲⅓") end) --["7"]
hs.hotkey.bind(super, hs.keycodes.map["-"], function() yabai({ "-m", "window", "--ratio", "abs:0.5" }) toast("🔲½") end) --["8"]
hs.hotkey.bind(super, hs.keycodes.map["/"], function() yabai({ "-m", "window", "--ratio", "abs:0.62" }) toast("🔲⅔") end) --["9"]
hs.hotkey.bind(super, hs.keycodes.map["="], function() yabai({ "-m", "space", "--balance" }) toast("🔲⚖️") end) --["-"]


--# modals

local focus_display_mod = hs.hotkey.modal.new(super, hs.keycodes.map["."]) --["v"]
local insert_window_modal = hs.hotkey.modal.new(super, hs.keycodes.map["tab"])
local move_display_modal = hs.hotkey.modal.new(super, hs.keycodes.map["k"]) --["b"]
...
focus_display_mod:bind(super, hs.keycodes.map["n"],
	function() yabai({ "-m", "display", "--focus", "next" }, function() delayed(function() toast("🖥➡️") end, 0.1) end)
		focus_display_mod
			:exit()
	end) --[";"]
focus_display_mod:bind(super, hs.keycodes.map["t"],
	function() yabai({ "-m", "display", "--focus", "prev" }, function() delayed(function() toast("🖥⬅️") end, 0.1) end)
		focus_display_mod
			:exit()
	end) --["j"]
...
insert_window_modal:bind(super, hs.keycodes.map["n"], function() yabai({ "-m", "window", "--insert", "east" }) end) --[";"]
insert_window_modal:bind(super, hs.keycodes.map["t"], function() yabai({ "-m", "window", "--insert", "west" }) end) --["j"]
insert_window_modal:bind(super, hs.keycodes.map["r"], function() yabai({ "-m", "window", "--insert", "north" }) end) --["l"]
insert_window_modal:bind(super, hs.keycodes.map["s"], function() yabai({ "-m", "window", "--insert", "south" }) end) --["k"]
insert_window_modal:bind(super, hs.keycodes.map["c"], function() yabai({ "-m", "window", "--insert", "stack" }) end) --["h"]
insert_window_modal:bind(super, hs.keycodes.map["tab"],
	function() insert_window_modal:exit() resize_window_modal:enter() end)
...
--# debug
hs.hotkey.bind(super, hs.keycodes.map["$"],
	function() yabai({ "-m", "query", "--windows", "--window" }, function(out) print(out) end) toast("🐞") end) --["§"]
