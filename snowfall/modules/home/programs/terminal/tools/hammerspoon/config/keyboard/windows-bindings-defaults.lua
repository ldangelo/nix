...
return {
  ...
  trigger   = 's',
  mappings  = {
    { {}, 'return', 'maximize', 'Full Screen' },
    { {}, 'space', 'secondThird', 'Center' },
    { {}, 'c', 'secondThird', 'Center' },
    { {}, 'r', 'thirdThird', 'Right Side' },
    { { 'shift' }, 'r', 'secondHalf', 'Right Side' },
    { {}, 'l', 'firstThird', 'Left Side' },
    { { 'shift' }, 'l', 'firstHalf', 'Left Side' },
    { {}, 'm', 'moveWindow', 'Move Window' },
  }
}
