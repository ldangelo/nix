...
---@return nil
function lad.set_keymaps(lhs, rhs, mode, opts)
  opts = opts or {}
...
---@return nil
function lad.create_user_command(name, desc, command, opts)
...
---@return nil
function lad.create_autocmd(autocmd, opts)
  opts = opts or {}
